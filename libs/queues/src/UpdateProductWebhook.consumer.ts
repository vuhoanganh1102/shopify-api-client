...
@Injectable()
@Processor(QueueChanel.UPDATE_PRODUCT_WEBHOOK) // limited 10 jobs is run in time
export class UpdateProductWebhookConsumer extends WorkerHost {
  ...
  async process(job: Job<any, any, string>): Promise<any> {
    ...
    await this.processProductUpdateWebhook(jobData);
    return {};
  }

  async processProductUpdateWebhook(data: any) {
